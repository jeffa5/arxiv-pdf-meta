...
function main()
    ...
    println(first(rows_with_length(df, :title_length, 1), 10))
    println(first(rows_with_length(df, :title_length, 2), 10))
    println(most_popular(df, :title_length, 10))

    has_author(df)
    author_length(df)
    author_length_no_zero(df)
    println(first(rows_with_length(df, :author_length, 1), 10))
    println(first(rows_with_length(df, :author_length, 2), 10))
